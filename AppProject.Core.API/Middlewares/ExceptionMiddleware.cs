        ...
        catch (AppException exception)
        {
            ...
            switch (exception.ExceptionCode)
            {
                ...
                case ExceptionCode.RequestValidation:
                    await this.HandleExceptionAsync(context, exception.ExceptionCode, exception.AddtionalInfo, httpStatusCode: HttpStatusCode.BadRequest);
                    return;
            }

            await this.HandleExceptionAsync(context, exception.ExceptionCode, exception.AddtionalInfo);
        }
